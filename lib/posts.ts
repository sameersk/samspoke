...
const posts: Post[] = [
  {
    ...
    excerpt: "Data is definitive — or so we think. A deep dive into the cognitive biases that make even careful analysts see patterns that aren't there, and what to do about it.",
    date: "March 21, 2026",
    author: "Sameer",
  ...
  },
  {
    ...
    excerpt: "Counter-intuitively, the speakers who project hesitation and doubt often persuade more effectively than those who project authority. Here's the science behind it.",
    date: "March 14, 2026",
    author: "Sameer",
  ...
  },
  {
    ...
    excerpt: "Artificial intelligence is no longer a technology story — it's a business strategy story. Here's why every company, regardless of industry, needs to reckon with it now.",
    date: "March 15, 2026",
    author: "Sameer",
  ...
  },
  {
    ...
    excerpt: "Every company wants to be sustainable. Most also want to grow. These two goals aren't always compatible — and the companies being honest about that tension are the ones making real progress.",
    date: "March 8, 2026",
    author: "Sameer",
    readingTime: "6 min read",
    category: "Sustainability",
    featured: false,
    image: "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=1200&h=600&fit=crop&q=80",
    content: `
  ...
  },
  {
    ...
    excerpt: "The most productive people aren't the ones with the longest to-do lists. They're the ones who've figured out which tasks actually matter — and have the discipline to ignore the rest.",
    date: "March 1, 2026",
    author: "Sameer",
    readingTime: "5 min read",
    category: "Productivity",
    featured: false,
    image: "https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=1200&h=600&fit=crop&q=80",
    content: `
  ...
  },
  {
    ...
    excerpt: "Analytics can tell you what customers do. It struggles to tell you why. And the gap between those two things is where most product and marketing decisions go wrong.",
  ...
  {
    title: "Burnout",
    slug: "burnout-and-relationships",
    excerpt: "Some colleagues thrive through years at a demanding firm while others burn out within months. The difference often has nothing to do with the work itself.",
    date: "November 8, 2024",
    author: "Sameer",
    readingTime: "5 min read",
    category: "Productivity",
    featured: false,
    image: "https://images.unsplash.com/photo-1573497620053-ea5300f94f21?w=1200&h=600&fit=crop&q=80",
    content: `
      <p>I work at a consulting firm. My colleagues and I put in grueling long hours — trying to meet all of our deadlines and produce the highest quality of work to keep our clients satisfied. While having lunch with a colleague early last week, we noticed a pattern: within a year of working with the firm, many of our colleagues were showing signs of burnout. Many had entered their new job with strong dedication, long hours, and a drive to produce quality work. But a few months in, they ended up taking more breaks and working fewer hours.</p>
      <p>But what was an even more interesting pattern was that there were also many colleagues who weren't getting burnt out. So we had to know why that was the case and what they were doing differently.</p>
      <p>The first and obvious thing we looked at was whether they were working fewer hours to begin with and taking on less work. But we noticed that most of these people were taking on at least as many tasks as anyone else — and in many cases, more than an average colleague.</p>
      <p>So it seemed like it wasn't something within the working hours that was helping them, but most likely something beyond work — especially because:</p>
      <ol>
        <li>We did not find significant differences in their working relationships with colleagues compared to the rest.</li>
        <li>We also did not find much of a difference in the type or quality of work they were taking up either.</li>
      </ol>
      <p>This does not mean that factors like work environment, nature of work, and working hours have no impact on burnout rates. But it was interesting to note that despite having most of these factors consistent, there were still differences in whether people were getting burnt out. So we had to understand what those avoiding burnout were doing differently <em>beyond</em> work.</p>
      <p>We looked at our colleagues who were burnt out to get a direction about where to look for possible explanations. Eventually, we found one obvious pattern — most of the people who weren't burnt out also seemed to have great personal lives and relationships. I looked deeper into it and found a consistent thread: people who had better social lives, both inside and outside of work, were far less likely to experience burnout.</p>
      <h2>What the evidence shows</h2>
      <p>This was an interesting pattern, and I had to dig deeper. I began looking at what the evidence shows — and there were multiple studies backing up this hypothesis:</p>
      <ol>
        <li><strong>Extroverted workers were four times less likely to face burnout</strong> than their peers with more introverted personalities. The reason appears to be two-fold. First, many workplaces are designed to favour more extroverted behaviour. But a bigger reason is that extroverts are constantly meeting more people, going out, and making plans — and there seems to be something inherent about these interpersonal interactions that helps manage stress.</li>
        <li><strong>A separate study on school teachers</strong> found that there is a strong relationship between marital happiness and burnout rates. Teachers with greater marital happiness were much less likely to experience burnout.</li>
      </ol>
      <p>It appears that having strong social and personal relationships helps you detach from work after hours and forces you to think about other things. Beyond that, studies also show that people with strong, trustworthy relationships have more resilience when faced with tough situations. People who believe they have family and friends they can rely on — people who would support them through difficult times — are more likely to navigate those challenges with less chronic stress. Over time, this aggregates to significantly better long-term wellbeing.</p>
      <h2>The age factor</h2>
      <p>There is another pattern worth noting: lower levels of burnout with age. This could be a function of many things — experience, familiarity with the work, less intense learning curves. But this pattern perfectly aligns with a different statistic: more people tend to find better quality relationships as they grow older. Separate meta-analyses across 73 studies found the same result — a significant negative correlation between age and burnout rates.</p>
  ...
  },
  {
    ...
    slug: "is-it-too-late",
    excerpt: "The race to find a calling early in life has produced a lot of anxiety and surprisingly few outliers. Here's why starting late may actually be an advantage.",
    date: "August 22, 2024",
    author: "Sameer",
    readingTime: "4 min read",
    category: "Career",
    featured: false,
    image: "https://images.unsplash.com/photo-1455849318743-b2233052fcff?w=1200&h=600&fit=crop&q=80",
    content: `
      ...
      <p>Yet the idea stayed. The earlier you fixate yourself on a certain path, the more likely you are to have a competitive advantage and become an outlier. I constantly battled to "find my calling" and create something substantial. Every stage of life that passed felt like it might already be too late to start something new.</p>
      <p>We see similar mindsets everywhere — from parents building hectic schedules filled with abacus classes, piano lessons, and coaching classes from an early age to ensure their children don't fall behind. The assumption: get a head start, and you'll have a competitive advantage.</p>
      <p>Yet most of these "head starts" appear to do the opposite.</p>
      <p>When Sloboda and a colleague conducted a study with students at a British boarding school that recruited from around the country — where admission rested entirely on audition — they were surprised to find that the students classified as exceptional came from families that <em>didn't</em> provide any sort of head start. Compared to less accomplished students, the exceptional ones had not started playing at a younger age, were less likely to have had an instrument in the home early on, had taken fewer lessons before entering the school, and had practiced less overall before arriving — often considerably less.</p>
      <h2>Why starting late can be an advantage</h2>
      <p>This phenomenon is explored at length in the book <em>Range</em> by David Epstein. Several reasons emerge for why people with impactful, fulfilling careers often start late:</p>
      <ol>
        <li><strong>Self-discovery:</strong> They are able to explore several alternative paths, switch across domains a couple of times, and truly discover the careers best suited to their individual personalities. This process of self-discovery can extend well into later life depending on your circumstances. Some who discover their calling early have had the privilege of testing various domains and finding a match. But many of us don't get that opportunity earlier due to socioeconomic conditions — meaning the process of genuine self-discovery begins much later.</li>
        <li><strong>Finding grit:</strong> The most important factor defining our ability to persevere toward a passion. It's unlikely that a career you fixate on in your teens — chosen from a narrow set of options — is the one you'll be perfectly matched with for life. Much of our personality evolves between 18 and our late twenties, meaning that later in life, with more exploration, we're far more likely to find a career we can pursue with genuine, sustained passion.</li>
        <li><strong>Critical thinking:</strong> People who specialise early tend to spend an exorbitant amount of time within a very narrow field. As a result, they can become accustomed to a single way of thinking — which limits their ability to draw on ideas from elsewhere. People who start late and explore broadly tend to develop stronger critical thinking because they've been exposed to many different ways of framing and solving problems. The breadth of experience becomes the edge.</li>
      </ol>
      <p>The fear of starting late is almost always more damaging than the late start itself. The people who've made the most meaningful contributions to their fields are rarely the ones who got there first — they're the ones who got there with the most range.</p>
    `,
  },
  {
    title: "Why I Just Wear a Plain Black Shirt Every Day",
    slug: "plain-black-shirt",
    excerpt: "For the last 90 days, I've worn the same plain black shirt every day. Here's what I learned about simplicity, perception, and decision fatigue.",
    date: "May 3, 2024",
    author: "Sameer",
    ...
    content: `
      <p>For the last 90 days I have been wearing just a plain black shirt every single day. Here's my rationale and what I observed by doing so.</p>
      <h2>1. No one cares</h2>
      <p>You may think that people instantly recognise that you've been wearing the same shirt for consecutive days. But really, everyone's much more worried about how presentable and fashionable they themselves appear. When people do notice someone else's outfit, it's usually because they're trying to compare or replicate a good look — not to judge consistency. The only thing that actually matters is that you don't look shabby. Look decent and refined, and most people will simply register that you look put-together.</p>
      <h2>2. Effortlessly look decent</h2>
      <p>Every morning, we spend some of the freshest energy of the day deciding what to wear — a decision that usually attracts far less attention than we believe. But picking something without thought can affect your aesthetic. The goal is to look considered without spending much thought on it. Choosing the same crisp, clean outfit solves the problem neatly: it saves cognitive energy while maintaining your appearance.</p>
      <h2>3. Setting expectations for the day</h2>
      <p>Every time we dress, we often do so based on how we expect the day to play out. This forces us to set a tone before the day has even begun. If you expect something great and the day disappoints, you carry the mismatch. If you expect something grim, you move through the day with that weight. When you don't have to make a choice about what to wear, you're less compelled to pre-script your day — which allows you to move through it with a more open mind.</p>
      <h2>4. More recognisable</h2>
      <p>When you wear a similar outfit every day, people tend to feel more familiar with you than they otherwise would. They remember interactions with you more distinctly, because your consistent appearance serves as an anchor. I noticed the effect personally — professors became more familiar with me and remembered my attendance more clearly. There's something about visual consistency that accelerates a sense of familiarity.</p>
      <h2>5. Real connection</h2>
      <p>When you don't wear an entirely new look every day, people find it easier to settle into your company. They don't have to recalibrate to a slightly different version of you each time. That reduces the buffer and allows conversations and connections to pick up more quickly from where they left off.</p>
      <p>None of this is about minimalism as an ideology. It's simply that the mental overhead of clothing choices is real, and eliminating it — even just for a stretch — frees up something you'd rather spend elsewhere.</p>
    `,
  },
];
